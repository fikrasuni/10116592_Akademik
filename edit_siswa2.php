...
$id = $_GET['nis'];
$hajarbos = mysqli_query("SELECT * FROM siswa WHERE idSiswa = $id");
$hasil = mysqli_fetch_array($hajarbos);
?>
<script type="text/javascript" src="js/pesan.js"></script>

<h2 align="center"><u>Edit Data Siswa </u></h2>
<form name="form" id="form" class="form" action="update_siswa2.php" onsubmit="return validate(this)" method="post">
